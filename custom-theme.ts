...
export const myCustomTheme: CustomThemeConfig = {
    ...
    properties: {
		...
		"--color-primary-100": "213 225 210", // #d5e1d2
		"--color-primary-200": "203 218 199", // #cbdac7
		"--color-primary-300": "171 195 165", // #abc3a5
		"--color-primary-400": "108 150 98", // #6c9662
		"--color-primary-500": "45 105 30", // #2d691e
		"--color-primary-600": "41 95 27", // #295f1b
		"--color-primary-700": "34 79 23", // #224f17
		"--color-primary-800": "27 63 18", // #1b3f12
		"--color-primary-900": "22 51 15", // #16330f
		// secondary | #4F46E5 
